declare global {
  ...
  interface URIStaticInterface {
    ...
    setQuery(data: QueryData, name: string | QueryData, value?: string | string[] | null): void;
    removeQuery(data: QueryData, name?: string | string[] | RegExp | QueryData, value?: string | string[] | number | RegExp): void;
