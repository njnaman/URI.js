...
interface URITemplateInterface {
  ...
  expression: string;
  parts?: Array<string | URITemplateExpression>;

  expand(data: URITemplateData | DataInterface, opts?: URITemplateExpandOptions): string;
  parse(): URITemplateInterface;

  // Static properties and methods
  _cache: { [key: string]: URITemplateInterface };
...
(function (root: any, factory) {
  ...
  p.parse = function(): URITemplateInterface {
    // performance crap
  ...
  Data.prototype.get = function(key: string): URITemplateDataValue {
    ...
    if (value === undefined || value === null) {
      ...
      for (const key in value) {
        if (hasOwn.call(value, key) && value[key] !== undefined && value[key] !== null) {
